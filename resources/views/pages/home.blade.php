...
{{-- Hero Section --}}
<section class="relative pt-28 pb-20 lg:pt-36 lg:pb-28 overflow-hidden bg-gradient-to-br from-surface-950 via-primary-950 to-surface-900" id="hero">
    {{-- Animated particle canvas --}}
    <canvas id="hero-particles" class="absolute inset-0 w-full h-full"></canvas>
    {{-- Animated gradient orbs --}}
    <div class="absolute top-0 left-1/4 w-[500px] h-[500px] rounded-full bg-primary-600/15 blur-[120px] animate-orb-1"></div>
    <div class="absolute bottom-0 right-1/4 w-[400px] h-100 rounded-full bg-accent-500/15 blur-[100px] animate-orb-2"></div>
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-primary-500/5 blur-[150px]"></div>
    {{-- Grid pattern --}}
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="mt-12 flex flex-wrap items-center gap-6 justify-center lg:justify-start animate-fade-in" style="animation-delay: 0.5s;">
                    <div class="flex items-center gap-2">
                        <div class="flex -space-x-2">
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 border-2 border-surface-900 flex items-center justify-center text-white text-[10px] font-bold">G</div>
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-green-400 to-green-600 border-2 border-surface-900 flex items-center justify-center text-white text-[10px] font-bold">Z</div>
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 border-2 border-surface-900 flex items-center justify-center text-white text-[10px] font-bold">A</div>
                        </div>
            ...
            <div class="hidden lg:block relative animate-fade-in" style="animation-delay: 0.3s;">
                <div class="relative">
                    {{-- Main visual card --}}
                    <div class="relative rounded-3xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl border border-white/10 p-8 overflow-hidden">
                        {{-- Inner glow --}}
                        ...
                        <div class="relative space-y-4">
                            ...
                            <div class="mt-6 space-y-2">
                                ...
                                <div class="h-1.5 rounded-full bg-white/5 overflow-hidden">
                                    <div class="h-full rounded-full bg-gradient-to-r from-primary-500 to-accent-500 animate-progress-bar"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="absolute -bottom-6 -left-6 bg-surface-900/90 backdrop-blur-xl shadow-2xl shadow-black/20 rounded-2xl p-4 border border-white/10 animate-float">
                        <div class="flex items-center gap-3">
                            <div class="w-11 h-11 rounded-xl bg-gradient-to-br from-green-500/20 to-emerald-500/20 flex items-center justify-center">
                    ...
                    <div class="absolute -top-5 -right-5 bg-surface-900/90 backdrop-blur-xl shadow-2xl shadow-black/20 rounded-2xl p-4 border border-white/10 animate-float" style="animation-delay: 1.5s;">
                        <div class="flex items-center gap-3">
                            <div class="w-11 h-11 rounded-xl bg-gradient-to-br from-amber-500/20 to-orange-500/20 flex items-center justify-center">
                    ...
                    <div class="absolute top-1/2 -right-8 -translate-y-1/2 bg-surface-900/90 backdrop-blur-xl shadow-2xl shadow-black/20 rounded-2xl p-4 border border-white/10 animate-float" style="animation-delay: 3s;">
                        <div class="flex items-center gap-3">
                            <div class="w-11 h-11 rounded-xl bg-gradient-to-br from-primary-500/20 to-blue-500/20 flex items-center justify-center">
...
{{-- Stats Bar --}}
<section class="bg-gradient-to-r from-primary-700 via-primary-600 to-accent-600 py-14">
...
{{-- Services --}}
<section class="py-24 bg-gradient-to-br from-white via-primary-50/30 to-accent-50/20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
{{-- Why Choose Us --}}
<section class="relative py-28 bg-gradient-to-br from-surface-950 via-primary-950 to-surface-900 overflow-hidden">
    {{-- Decorative elements --}}
    <div class="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-primary-500/30 to-transparent"></div>
    <div class="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-accent-500/30 to-transparent"></div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative">
            ...
            <div class="hidden lg:block absolute top-[60px] left-[calc(12.5%+28px)] right-[calc(12.5%+28px)] h-0.5">
                <div class="w-full h-full bg-gradient-to-r from-primary-500/50 via-accent-500/50 to-orange-500/50 rounded-full"></div>
            </div>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="group relative text-center reveal" style="animation-delay: {{ $step[6] }};">
                    {{-- Step number circle --}}
                    <div class="relative z-10 w-[120px] h-[120px] mx-auto mb-8">
                        {{-- Animated ring --}}
                        <div class="absolute inset-0 rounded-full bg-gradient-to-br {{ $step[3] }} opacity-20 group-hover:opacity-40 group-hover:scale-110 transition-all duration-500"></div>
                        <div class="absolute inset-[3px] rounded-full bg-surface-900/95"></div>
                    ...
                    {{-- Content card --}}
                    <div class="p-6 rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:bg-white/[0.06] hover:border-{{ $step[5] }}-500/20 transition-all duration-500">
...
{{-- Tech Stack --}}
<section class="py-20 bg-gradient-to-b from-primary-50/60 via-white to-accent-50/30 border-y border-primary-100/50 overflow-hidden">
    ...
    <div class="relative">
        <div class="absolute left-0 top-0 bottom-0 w-40 bg-gradient-to-r from-primary-50/60 via-primary-50/30 to-transparent z-10"></div>
        <div class="absolute right-0 top-0 bottom-0 w-40 bg-gradient-to-l from-accent-50/30 via-accent-50/15 to-transparent z-10"></div>
        <div class="flex gap-5 animate-marquee">
            ...
            <div class="shrink-0 group flex flex-col items-center gap-2.5 w-28 py-5 rounded-2xl bg-gradient-to-br {{ $tech[2] }} border border-white/80 shadow-sm whitespace-nowrap hover:shadow-lg hover:-translate-y-1 hover:border-{{ $tech[3] }}-200 transition-all duration-300">
...
{{-- Portfolio --}}
<section class="py-28 bg-gradient-to-b from-surface-50 via-white to-surface-50 overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-10 reveal">
            <div class="group relative rounded-3xl overflow-hidden bg-gradient-to-br from-blue-600 via-primary-600 to-accent-600 p-1">
                <div class="rounded-[calc(1.5rem-4px)] bg-white overflow-hidden">
                    <div class="grid lg:grid-cols-2">
                        <div class="aspect-[4/3] lg:aspect-auto bg-gradient-to-br from-blue-50 via-primary-50 to-accent-50 flex items-center justify-center p-12 relative overflow-hidden">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="group relative rounded-2xl overflow-hidden bg-white border border-surface-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-500 reveal">
                {{-- Gradient top bar --}}
                <div class="h-1.5 bg-gradient-to-r {{ $project[3] }}"></div>
                <div class="aspect-[16/10] bg-gradient-to-br {{ $project[4] }} flex items-center justify-center relative p-6 overflow-hidden">
                    <div class="text-center relative z-10">
                    ...
                    {{-- Hover overlay --}}
                    <div class="absolute inset-0 bg-gradient-to-br {{ $project[3] }} opacity-0 group-hover:opacity-90 flex items-center justify-center transition-all duration-500">
...
{{-- Testimonials --}}
<section class="py-24 bg-gradient-to-br from-accent-50/30 via-white to-primary-50/30">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16 reveal">
...
{{-- Clients Section - Dark Cinematic --}}
<section class="relative py-24 bg-gradient-to-br from-surface-950 via-surface-900 to-primary-950 overflow-hidden">
    {{-- Decorative elements --}}
    <div class="absolute top-0 left-1/3 w-[400px] h-[400px] rounded-full bg-primary-600/10 blur-[120px]"></div>
    <div class="absolute bottom-0 right-1/4 w-[300px] h-[300px] rounded-full bg-accent-500/10 blur-[100px]"></div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {{-- Client Grid --}}
        <div class="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-9 gap-4 mb-16">
            @foreach([
            ...
            <div class="group relative aspect-square rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-primary-500/50 hover:bg-white/10 flex items-center justify-center p-5 transition-all duration-500 overflow-hidden reveal" style="animation-delay: {{ $index * 0.08 }}s;">
                {{-- Hover glow --}}
                <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-br from-primary-500/10 via-transparent to-accent-500/10"></div>
                {{-- Logo --}}
                <img src="{{ asset('images/logos/' . $client[1]) }}" alt="{{ $client[0] }}" class="relative max-h-12 max-w-[80px] object-contain brightness-0 invert opacity-40 group-hover:opacity-90 group-hover:brightness-100 group-hover:invert-0 transition-all duration-500" loading="lazy">
                {{-- Name tooltip --}}
                <div class="absolute -bottom-1 left-1/2 -translate-x-1/2 translate-y-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100 group-hover:bottom-3 transition-all duration-300 pointer-events-none">
                    <span class="px-2.5 py-1 rounded-lg bg-white/90 text-surface-900 text-[10px] font-bold whitespace-nowrap shadow-lg">{{ $client[0] }}</span>
                </div>
            </div>
            @endforeach
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            ...
            <div class="text-center p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 reveal">
                <div class="w-10 h-10 mx-auto mb-3 rounded-xl bg-gradient-to-br {{ $stat[3] }} flex items-center justify-center">
...
{{-- Blog Preview --}}
<section class="py-24 bg-gradient-to-br from-white via-accent-50/20 to-primary-50/20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16 reveal">
            <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent-50 text-accent-600 text-sm font-medium mb-4">
