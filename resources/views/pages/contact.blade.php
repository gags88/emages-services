...
<section class="relative pt-32 pb-20 overflow-hidden bg-white">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-surface-500 max-w-3xl mx-auto animate-slide-up delay-200">Have a project in mind? Get in touch and let's discuss how we can help transform your digital presence.</p>
    </div>
</section>
